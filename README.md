...
- **The passbook** — CREDITS: rain fallen in the last 24 h (the gauge's reading now against its reading a day ago, refreshed the moment the gauge ticks — a shower prints while it's still raining), the drip's run when it watered today ("paid"), and rain promised but unredeemed (the 24-h forecast). DEBITS: what the sun evaporated yesterday, and drainage. Then the double-ruled **BALANCE OWED TO THE SOIL**, red when owed, green when in credit.
